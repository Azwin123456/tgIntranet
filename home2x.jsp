    ...
    <body  bgcolor="#E7ECF9" background="pic/bot_bg2.gif">
      ...
      <table border="0">
        <tr>
          ...
          <td class="text-cell">
               <span class="message1"><div style="word-wrap: break-word;width:500px" ><%= captionT %></div> </span> 
            <p class="message2">
...
<td><a href="http://10.3.11.182:8080/tgIntranet/MessageServlet" target="tg" >More</a></td></tr>
</table>
</div>
    ...
    <table border="0" class="bottom-news">
      ...
      <table border="0">
        <tr>
          ...
          <td class="text-cell">
              <span class="message3"><div style="word-wrap: break-word;width:280px"><%= lbb.getCaption() %></div> </span>
              <div style="word-wrap: break-word;width:280px"><%= lbb.getBrief() %></div>
        
        
        <% if(lbb.getMore().equals("y")){%>
            <div align="right">            
<table class="more"  border=0>
<tr><td><img border="0" src="pic/arrow3.gif" width="9" height="7" vspace="5" align="absmiddle"></td>
<td><a href="http://10.3.11.182:8080/tgIntranet/MessageServletLB" target="tg" >More</a></td></tr>
</table>
</div>
            <%}%>
      ...
      <table border="0">
        <tr>
          ...
          <td class="text-cell">
              <span class="message3"><div style="word-wrap: break-word;width:280px"><%= rbb.getCaption() %></div></span>
            <div style="word-wrap: break-word;width:280px"><%= rbb.getBrief() %></div>
        <% if(rbb.getMore().equals("y")){%>
            <div align="right">            
<table class="more"  border=0>
<tr><td><img border="0" src="pic/arrow3.gif" width="9" height="7" vspace="5" align="absmiddle"></td>
<td><a href="http://10.3.11.182:8080/tgIntranet/MessageRBServlet" target="tg" >More</a></td></tr>
</table>
</div>
            <%}%>
