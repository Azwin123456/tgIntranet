<%-- 
    Document   : more
    Created on : Jan 4, 2012, 9:49:17 AM
    Author     : user
--%>
 ...
 function maxLengthPaste(field,maxChars)
 {
    ...
    <body>
        ...
        <table class="cctv2"  border="1" width="44%" align="center" id="table56" cellspacing="0" cellpadding="3" >
            <tr><td class="cctv18" bgcolor="white" colspan="3">Done!</td></tr>
            <tr><td class="cctv20" bgcolor="#FFFFFF">&nbsp;</td></tr>
            <tr><td class="cctv20" bgcolor="#FFFFFF"><div class="more"><img border="0" src="http://localhost:8080/tgIntranet/pic/arrow3.gif" width="9" height="7" vspace="5" align="absmiddle"><a href="admin/adminHome.jsp" target="tg2" >Home</a></div></td></tr>
