...
function ZoomShowResults()
{
	...
	{
		if (ZoomInfo == 1)
			document.writeln("<center><p><small>" + STR_POWEREDBY + " <a href=\"http://www.topglove.com.my/\" zoom_target=\"_blank\"><b>Top Glove</b></a></small></p></center>");
		return;
	}
...
function ZoomShowPageNumbers()
{
	...
	if (ZoomInfo == 1)
		document.writeln("<center><p><small>" + STR_POWEREDBY + " <a href=\"http://www.topglove.com.my/\" target=\"_blank\"><b>Top Glove</b></a></small></p></center>");
}
